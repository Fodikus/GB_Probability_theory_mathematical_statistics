...
formula = formula + 'a) Найти вероятность того, что все 4 карты – крести. \n'
...
formula = formula + 'где m число благоприятных исходов извлечь 4 карты одной масти \n'
formula = formula + 'в колоде 52 карты и 4 масти, соответственно 52/4=13 карт одной масти \n'
formula = formula + '$\\ m : \\ C^k_n = С^{4}_{13} $ \n'
...
# Ответ
result = P * 100
formula = formula + 'Вероятность того, что все 4 карты – крести:\n'
